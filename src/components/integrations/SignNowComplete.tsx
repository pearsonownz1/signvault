...
export default function SignNowComplete() {
  ...
  useEffect(() => {
    ...
    if (success === 'true') {
      setStatus('success');
      setAccountName(account || 'your SignNow account');
    } else if (error) {
      setStatus('error');
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-center">
            {status === 'success' ? 'Your SignNow account has been connected' : 
          ...
          {status === 'success' && (
            <>
              ...
              <p className="text-center text-sm text-muted-foreground">
                When documents are signed in SignNow, they will be automatically vaulted in your SignVault account.
              </p>
            </>
          )}
